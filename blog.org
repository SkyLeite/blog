...
*** TODO How I reverse engineered a dumb fighting game nobody cares about :games:programming:
CLOSED: [2023-07-08 sat 19:59]
:PROPERTIES:
:EXPORT_FILE_NAME: srb2-kart-wasm-port
:END:
...
If you've interacted with me in the past 6 months for even a fraction of a second, you probably know I'm currently obsessed with Umineko no Naku Koro Ni, a visual novel about murder mysteries, witchcraft, love and rats. It's an absurdly long story, usually taking short of 150 hours to complete, where people argue over the truth of closed room murders that somehow managed to be adapted into a fighting game called Ougon Musou Kyoku (Umineko: Golden Fantasia in the west). Of course, like most niche fighting games like this, the publisher doesn't seem to care much about balancing or quality of life upgrades so it's up to the community to do it.

Now, I've been obsessed with modding video games for the longest time. I love playing them, and I love programming, so it's a match made in heaven right? Well, not quite. I don't have formal Computer Science experience, so most of the low-level concepts are lost on me. I know what a stack and Assembly are, but since they were never immediately useful in my projects and my work, I never needed to learn them. But since you usually don't have access to the source code of the game you're modding, you better be familiar with these concepts because they're all you're gonna get.

Anyways, once I was done reading Umineko and had used up my bag of people to infodump to, I had to figure out another way of getting the dopamine rush of interacting with my favorite (?) game. I bought Ougon Musou Kyoku on Steam, loaded it up and was met with all animations playing at 50x speed, as if the game was made by a caffeinated squirrel.

After much deliberation, trying to figure out if something was wrong with my computer, I eventually figured out that by limiting the game's FPS to 60 using gamescope (=gamescope -r 60 -- %command%= as the game's launch parameters on Steam) the game ran smoothly again. The problem turned out to be that it uses vsync to limit itself to the monitor's refresh rate, and since I'm using a 240Hz monstrosity, everything ran at 4x the expected speed. So problem solved, right? Not for my brain.
